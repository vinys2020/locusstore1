...
const SobreNosotros = () => {
  ...
  return (
    <main className="sobre-nosotros bg-light text-dark" >
      ...
      {/* Misión */}
      <section className="container-light py-lg-5 mt-4 ">
        <div className="text-center mx-lg-5">
          <h2 className="mb-2 mb-lg-3">Nuestra Misión</h2>
          <p>
      ...
      <section className="container-light py-5">
        <div className="row align-items-center flex-column-reverse flex-md-row">
          <article className="col-12 col-md-6 slide-up mt-4 mt-md-0">
            <h2 className="mb-lg-3">Propósito y Valores</h2>
            <p>
      ...
      <section className="container-light py-lg-5 ">
      ...
      <section className="container-light py-5">
        <div className="row align-items-center flex-column-reverse flex-md-row">
          <article className="col-12 col-md-6 slide-up mt-4 mt-md-0">
            <h2 className="mb-lg-3">Experiencia y Asesoramiento</h2>
            <p>
