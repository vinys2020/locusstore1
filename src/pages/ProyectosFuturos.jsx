  ...
  return (
    <main className="pf-main bg-dark py-5">
      <div className="container">
        ...
        <section className="pf-project pf-slide-up mb-5">
          <div className="card pf-card shadow-sm border-0 rounded-4 overflow-hidden p-0 p-lg-3">
            <div className="row g-0 align-items-center flex-column-reverse flex-lg-row">
              <div className="col-lg-6 p-4 mt-lg-4">
                <h2 className="h4 fw-bold text-dark mb-lg-3">
                ...
                <p className="small text-primary mt-lg-3">
        ...
        <section className="pf-project pf-slide-up mb-5">
          <div className="card pf-card shadow-sm border-0 rounded-4 overflow-hidden p-0 p-lg-3">
            <div className="row g-0 align-items-center flex-column-reverse flex-lg-row-reverse">
              <div className="col-lg-6 p-4 mt-4 mt-lg-0">
        ...
        <section className="pf-project pf-slide-up mb-5">
          <div className="card pf-card shadow-sm border-0 rounded-4 overflow-hidden p-0 p-lg-3">
            <div className="row g-0 align-items-center flex-column-reverse flex-lg-row-reverse">
              <div className="col-lg-6 p-4 mt-lg-4 mt-lg-0">
                <h2 className="h4 fw-bold text-dark mb-lg-3">
