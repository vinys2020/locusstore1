...
import useProductosHerramientas from "../hooks/useProductosHerramientas"; // 👈 NUEVO HOOK
import { useNavigate } from "react-router-dom";
import { CartContext } from "../context/CartContext";
import "./HorizontalCarousel.css";

const HorizontalHerramientas = () => {
  const [isHovered, setIsHovered] = useState(false);
  const scrollRef = useRef(null);
  const navigate = useNavigate();

  const { productos, loading } = useProductosHerramientas(); // 👈 USO DEL HOOK NUEVO
...
export default HorizontalHerramientas;
