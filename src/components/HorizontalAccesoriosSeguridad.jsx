...
import useAccesoriosSeguridad from "../hooks/useAccesoriosSeguridad"; // 👈 NUEVO HOOK
import { useNavigate } from "react-router-dom";
import { CartContext } from "../context/CartContext";
import "./HorizontalCarousel.css";

const HorizontalAccesoriosSeguridad = () => {
  const [isHovered, setIsHovered] = useState(false);
  const scrollRef = useRef(null);
  const navigate = useNavigate();

  const { productos, loading } = useAccesoriosSeguridad(); // 👈 USO DEL HOOK
...
export default HorizontalAccesoriosSeguridad;
